        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes("leads") && "bg-slate-900"}`}>
                <NavLink
                  end
                  to="/leads"
                  className={`block text-slate-200 truncate transition duration-150 ${
                    pathname.includes("leads") ? "hover:text-slate-200" : "hover:text-white"
                  }`}
                >
                  <div className="flex items-center">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        ...
                        clipRule="evenodd"
                        d="M22 5C22 6.105 21.105 7 20 7C18.895 7 18 6.105 18 5C18 3.895 18.895 3 20 3C21.105 3 22 3.895 22 5ZM22 8H21.026H18.974H18C16.895 8 16 8.895 16 10V16H18V19V21C18 21.552 18.448 22 19 22H21C21.552 22 22 21.552 22 21V19V16H24V10C24 8.895 23.105 8 22 8Z"
                        className={`fill-current ${pathname.includes("leads") ? "text-indigo-500" : "text-slate-600"}`}
                      />
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M6 5C6 6.105 5.105 7 4 7C2.895 7 2 6.105 2 5C2 3.895 2.895 3 4 3C5.105 3 6 3.895 6 5ZM6 8H5.026H2.974H2C0.895 8 0 8.895 0 10V16H2V19V21C2 21.552 2.448 22 3 22H5C5.552 22 6 21.552 6 21V19V16H8V10C8 8.895 7.105 8 6 8Z"
                        className={`fill-current ${pathname.includes("leads") ? "text-indigo-300" : "text-slate-400"}`}
                      />
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                    ...
                    <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Leads</span>
                  </div>
                </NavLink>
              </li>
