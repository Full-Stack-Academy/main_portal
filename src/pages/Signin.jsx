...
const Signin = ({ setIsLoggedIn }) => {
  ...
  return (
    <>
      <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 h-screen bg-violet-900">
              ...
              <div className="mt-2">
                <input
                  ...
                  className={`block w-full rounded-md ${
                    valEmail ? "border-red-600" : "border-0"
            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  required
                  className={`block w-full rounded-md ${
                    valPass ? "border-red-600" : "border-0"
                  } py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6`}
                />
              </div>
            </div>
