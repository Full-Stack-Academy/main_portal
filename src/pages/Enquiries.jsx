      ...
      <main>
        <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          ...
          <div className="sm:flex sm:justify-between sm:items-center mb-8">
            {/* Left: Avatars */}
            {/* <DashboardAvatars /> */}
            <h2 className="text-3xl font-semibold text-slate-800 dark:text-slate-100 mb-2">Website Enquiries</h2>
          ...
          <div className="relative overflow-x-auto shadow-md rounded p-2">
